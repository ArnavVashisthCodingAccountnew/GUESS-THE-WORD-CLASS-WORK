...
player1_score = 0;
    ...
    document.getElementById("player_question").innerHTML = "Question (Pucho) Turn  " + player1_name;
    document.getElementById("player_answer").innerHTML = "Answer (Bataoo) Turn  " + player2_name;
    function send() {
